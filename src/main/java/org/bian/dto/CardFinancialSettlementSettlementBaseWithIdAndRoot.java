...
/**
 * CardFinancialSettlementSettlementBaseWithIdAndRoot
 */
public class CardFinancialSettlementSettlementBaseWithIdAndRoot   {
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Card Financial Settlement Process Reference 
